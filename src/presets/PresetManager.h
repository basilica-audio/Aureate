...
//
// This file (and PresetManager.cpp) is written to have NO Aureate-specific
...
namespace basilica::presets
{
    ...
    struct PresetManagerConfig
    {
        ...
        // "com.yvesvogl.aureate". A preset file whose "plugin" field doesn't
    ...
    // AureateAudioProcessor::processBlock/AureateEngine ever calls into
